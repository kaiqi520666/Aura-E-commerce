...
import * as entity1 from './modules/user/entity/address';
import * as entity2 from './modules/task/entity/log';
import * as entity3 from './modules/task/entity/info';
import * as entity4 from './modules/space/entity/type';
import * as entity5 from './modules/space/entity/info';
import * as entity6 from './modules/recycle/entity/data';
import * as entity7 from './modules/plugin/entity/info';
import * as entity8 from './modules/mall/entity/review';
import * as entity9 from './modules/mall/entity/product';
import * as entity10 from './modules/mall/entity/payment';
import * as entity11 from './modules/mall/entity/order';
import * as entity12 from './modules/mall/entity/order-item';
import * as entity13 from './modules/mall/entity/favorite';
import * as entity14 from './modules/mall/entity/category';
import * as entity15 from './modules/mall/entity/cart-item';
